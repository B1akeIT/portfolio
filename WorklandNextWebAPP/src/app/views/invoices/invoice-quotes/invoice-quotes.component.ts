...
@Component({
  selector: 'app-invoice-quotes',
  templateUrl: 'invoice-quotes.component.html',
  styleUrls: ['./invoice-quotes.component.scss']
})
export class InvoiceQuoteComponent implements OnInit {
  ...
  loadQuotes() {
    this.loading = true;
    this.quotesService.getQuoteJsonByDocument(this.invoiceId, this.tipoDocumentoId, this.macroTipoDocumento, this.aziendaId).subscribe(
      (response: any) => {
