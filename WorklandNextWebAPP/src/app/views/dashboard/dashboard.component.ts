...
import { CustomDateFormatter } from '@app/providers/custom-date-formatter.provider';
...
export class DashboardComponent implements OnInit, AfterViewInit {
  ...
  logoSrc = '/assets/img/brand/logo-workland-crm.png';
  ...
  constructor(
    ...
    this.isSetTenant = (this.authenticationService.getCurrentTenant() !== '');
