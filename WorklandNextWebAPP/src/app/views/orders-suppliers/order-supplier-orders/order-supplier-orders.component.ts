...
@Component({
  selector: 'app-order-supplier-orders',
  templateUrl: 'order-supplier-orders.component.html',
  styleUrls: ['./order-supplier-orders.component.scss']
})
export class OrderSupplierOrdersComponent implements OnInit {
  ...
  loadOrders() {
    this.loading = true;
    this.ordersService.getOrderJsonByDocument(this.orderId, this.tipoDocumentoId, this.macroTipoDocumento, this.aziendaId).subscribe(
      (response: any) => {
