...
@Component({
  selector: 'app-order-supplier-inspector',
  templateUrl: './order-supplier-inspector.component.html',
  styleUrls: ['./order-supplier-inspector.component.scss']
})
export class OrderSupplierInspectorComponent implements OnInit, OnChanges {
