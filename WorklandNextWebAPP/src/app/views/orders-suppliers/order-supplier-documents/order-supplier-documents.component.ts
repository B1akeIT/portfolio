...
@Component({
  selector: 'app-order-supplier-documents',
  templateUrl: 'order-supplier-documents.component.html',
  styleUrls: ['./order-supplier-documents.component.scss']
})
export class OrderSupplierDocumentsComponent implements OnInit {
  ...
  loadDocuments() {
    this.loading = true;
    this.ddtService.getDocumentsJsonByDocument(this.orderId, this.tipoDocumentoId, this.macroTipoDocumento, this.aziendaId).subscribe(
      (response: any) => {
