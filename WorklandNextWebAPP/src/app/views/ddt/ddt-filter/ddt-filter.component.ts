...
@Component({
  selector: 'app-ddt-filter',
  templateUrl: './ddt-filter.component.html',
  styleUrls: ['./ddt-filter.component.scss']
})
export class DdtFilterComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    // this.ddtsService.getListChoices('tab_qualifica').subscribe(
    //   (data: any) => {
