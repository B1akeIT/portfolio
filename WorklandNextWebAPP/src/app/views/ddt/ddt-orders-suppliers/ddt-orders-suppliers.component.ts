...
@Component({
  selector: 'app-ddt-orders-suppliers',
  templateUrl: 'ddt-orders-suppliers.component.html',
  styleUrls: ['./ddt-orders-suppliers.component.scss']
})
export class DdtOrdersSuppliersComponent implements OnInit {
  ...
  loadOrders() {
    this.loading = true;
    this.ordersSuppliersService.getOrderSuppliersJsonByDocument(this.ddtId, this.tipoDocumentoId, this.macroTipoDocumento, this.aziendaId).subscribe(
      (response: any) => {
