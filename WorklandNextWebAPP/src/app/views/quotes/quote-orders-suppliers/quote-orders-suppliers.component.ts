...
@Component({
  selector: 'app-quote-orders-suppliers',
  templateUrl: 'quote-orders-suppliers.component.html',
  styleUrls: ['./quote-orders-suppliers.component.scss']
})
export class QuoteOrdersSuppliersComponent implements OnInit {
  ...
  loadOrders() {
    this.loading = true;
    this.ordersSuppliersService.getOrderSuppliersJsonByDocument(this.quoteId, this.tipoDocumentoId, this.macroTipoDocumento, this.aziendaId).subscribe(
      (response: any) => {
