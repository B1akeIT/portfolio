...
@Component({
  selector: 'app-contact-ddt',
  templateUrl: 'contact-ddt.component.html',
  styleUrls: ['./contact-ddt.component.scss']
})
export class ContactDdtComponent implements OnInit {
  ...
  loadOrders() {
    this.loading = true;
    this.ddtService.getDdtContact(this.contactId).subscribe(
      (response: any) => {
