...
export class OrdersService extends BaseService {
  ...
  model = 'OrdineClienteTestata';
  modelDettaglio = 'OrdineClienteDettaglio';
  ...
  _getOrderDefaultValues(aziendaId) {
    ...
    let httpParams = new HttpParams();
    httpParams = httpParams.set('nomeSp', 'SpGetDefaultOrdineClienteTestata');
  ...
  getOrderJsonByDocument(dId: number, tDId: number, mTD: number, aId: number) {
    let httpParams = new HttpParams();
