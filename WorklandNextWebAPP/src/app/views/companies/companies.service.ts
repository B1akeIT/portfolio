...
export class CompaniesService extends BaseService {
  ...
  saveCompany(tenant, body) {
    ...
    delete body.magazzinoList;
    delete body.filialiList;
    delete body.logo;

    if (companyId && companyId !== 0 ) {
      resultObs = this.http
        .put(`${this.apiUrl}/${this.model}/${companyId}`, body, this.httpOptions);
    } else {
      delete body.id;
      resultObs = this.http
  ...
  getListWarehouses(companyId) {
    ...
    return this.http.get<any[]>(`${this.apiUrl}/magazzino/${this.model}/${companyId}`, this.httpOptions);
  }
}
