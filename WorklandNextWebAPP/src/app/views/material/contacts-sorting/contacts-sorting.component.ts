...
@Component({
  selector: 'app-contacts-sorting',
  templateUrl: './contacts-sorting.component.html',
  styleUrls: ['./contacts-sorting.component.scss']
})
export class ContactsSortingComponent implements OnInit {
